...
export default function NewIngredientSDModified(props) {
    return (
             <div id={props.identifiant} className="new-ingredient adding">
                 {props.id}
                  <div className="form-group">
                      <p>{props.ingredient}</p>
                      <textarea value={props.value} name="ingredients" onChange={props.onChange} placeholder={props.placeholder}></textarea>
                  </div>
